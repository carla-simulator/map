 ...
 */
template <> struct fmt::formatter<::ad::physics::Distance3D> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::Distance3D const &value, FormatContext &ctx)
  {
