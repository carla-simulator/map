 ...
 */
template <> struct fmt::formatter<::ad::physics::VelocityList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::VelocityList const &value, FormatContext &ctx)
  {
