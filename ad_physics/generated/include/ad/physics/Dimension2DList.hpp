 ...
 */
template <> struct fmt::formatter<::ad::physics::Dimension2DList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::Dimension2DList const &value, FormatContext &ctx)
  {
