 ...
 */
template <> struct fmt::formatter<::ad::physics::WeightList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::WeightList const &value, FormatContext &ctx)
  {
