 ...
 */
template <> struct fmt::formatter<::ad::physics::Dimension3D> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::Dimension3D const &value, FormatContext &ctx)
  {
