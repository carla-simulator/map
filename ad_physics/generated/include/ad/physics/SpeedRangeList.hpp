 ...
 */
template <> struct fmt::formatter<::ad::physics::SpeedRangeList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::SpeedRangeList const &value, FormatContext &ctx)
  {
