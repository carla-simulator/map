 ...
 */
template <> struct fmt::formatter<::ad::physics::RatioValueList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::RatioValueList const &value, FormatContext &ctx)
  {
