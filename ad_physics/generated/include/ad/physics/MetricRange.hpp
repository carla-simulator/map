 ...
 */
template <> struct fmt::formatter<::ad::physics::MetricRange> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::MetricRange const &value, FormatContext &ctx)
  {
