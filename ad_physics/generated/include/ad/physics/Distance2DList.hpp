 ...
 */
template <> struct fmt::formatter<::ad::physics::Distance2DList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::Distance2DList const &value, FormatContext &ctx)
  {
