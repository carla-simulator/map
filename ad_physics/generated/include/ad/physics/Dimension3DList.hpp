 ...
 */
template <> struct fmt::formatter<::ad::physics::Dimension3DList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::Dimension3DList const &value, FormatContext &ctx)
  {
