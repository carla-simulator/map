 ...
 */
template <> struct fmt::formatter<::ad::physics::SpeedSquaredList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::SpeedSquaredList const &value, FormatContext &ctx)
  {
