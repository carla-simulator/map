 ...
 */
template <> struct fmt::formatter<::ad::physics::Acceleration3D> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::Acceleration3D const &value, FormatContext &ctx)
  {
