 ...
 */
template <> struct fmt::formatter<::ad::physics::AngularVelocity3D> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::AngularVelocity3D const &value, FormatContext &ctx)
  {
