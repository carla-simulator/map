 ...
 */
template <> struct fmt::formatter<::ad::physics::ParametricRange> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::ParametricRange const &value, FormatContext &ctx)
  {
