...
public:
  /*!
   * \brief constant defining the minimum valid Distance value (used in isValid())
   */
  static const double cMinValue;

  /*!
   * \brief constant defining the maximum valid Distance value (used in isValid())
   */
   ...
   *
   * \note \ref \_AD_PHYSICS_DISTANCE_EXPLICIT_CONVERSION\_ defines, if only an explicit conversion is allowed.
   */
