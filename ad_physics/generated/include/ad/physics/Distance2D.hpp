 ...
 */
template <> struct fmt::formatter<::ad::physics::Distance2D> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::Distance2D const &value, FormatContext &ctx)
  {
