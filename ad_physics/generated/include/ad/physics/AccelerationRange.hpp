 ...
 */
template <> struct fmt::formatter<::ad::physics::AccelerationRange> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::AccelerationRange const &value, FormatContext &ctx)
  {
