 ...
 */
template <> struct fmt::formatter<::ad::physics::AngularVelocity3DList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::AngularVelocity3DList const &value, FormatContext &ctx)
  {
