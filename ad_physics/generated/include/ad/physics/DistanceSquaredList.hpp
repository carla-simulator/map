 ...
 */
template <> struct fmt::formatter<::ad::physics::DistanceSquaredList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::DistanceSquaredList const &value, FormatContext &ctx)
  {
