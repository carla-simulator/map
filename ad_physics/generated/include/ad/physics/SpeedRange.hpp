 ...
 */
template <> struct fmt::formatter<::ad::physics::SpeedRange> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::SpeedRange const &value, FormatContext &ctx)
  {
