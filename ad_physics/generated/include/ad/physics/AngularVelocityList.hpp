 ...
 */
template <> struct fmt::formatter<::ad::physics::AngularVelocityList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::AngularVelocityList const &value, FormatContext &ctx)
  {
