 ...
 */
template <> struct fmt::formatter<::ad::physics::ParametricRangeList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::ParametricRangeList const &value, FormatContext &ctx)
  {
