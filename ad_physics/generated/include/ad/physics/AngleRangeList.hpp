 ...
 */
template <> struct fmt::formatter<::ad::physics::AngleRangeList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::AngleRangeList const &value, FormatContext &ctx)
  {
