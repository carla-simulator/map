 ...
 */
template <> struct fmt::formatter<::ad::physics::AngleRange> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::physics::AngleRange const &value, FormatContext &ctx)
  {
