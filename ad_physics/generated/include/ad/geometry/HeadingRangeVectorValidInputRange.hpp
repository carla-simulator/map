 ...
 */
inline bool withinValidInputRange(::ad::geometry::HeadingRangeVector const &input, bool const logErrors = true)
{
  ...
  if (inValidInputRange)
  {
    for (auto const &member : input)
    {
      ...
      {
        spdlog::error("withinValidInputRange(::ad::geometry::HeadingRangeVector)>> {}, invalid member {}",
                      input,
