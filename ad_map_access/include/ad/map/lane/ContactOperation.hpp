 ...
 */
inline bool isAccessOk(ContactLane const &contactLane, restriction::VehicleDescriptor const &vehicle)
{
 ...
 */
inline bool isValid(ContactLane const &contactLane, bool const logErrors = true)
{
