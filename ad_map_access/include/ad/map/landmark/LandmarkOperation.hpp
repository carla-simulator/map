 ...
 *          Throws std::invalid_argument if landmark does not exist in the store.
 */
...
/**
 * @brief Method to be called to retrieve Landmark from the Store and convert to ENU representation.
 * @param[in] id Landmark identifier.
 * @returns Landmark with given identifier.
