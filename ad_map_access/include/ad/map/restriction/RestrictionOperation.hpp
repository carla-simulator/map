 ...
 */
inline bool isValid(VehicleDescriptor const &descriptor, bool const logErrors = true)
{
 ...
 */
inline bool isValid(Restriction const &restriction, bool const logErrors = true)
{
 ...
 */
inline bool isValid(Restrictions const &restrictions, bool const logErrors = true)
{
