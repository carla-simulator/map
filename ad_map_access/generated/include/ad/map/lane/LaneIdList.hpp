 ...
 *
 */
inline std::ostream &operator<<(std::ostream &os, vector<::ad::map::lane::LaneId> const &_value)
{
  os << "[";
 ...
 */
template <> struct fmt::formatter<::ad::map::lane::LaneIdList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::lane::LaneIdList const &value, FormatContext &ctx)
  {
