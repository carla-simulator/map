 ...
 */
template <> struct fmt::formatter<::ad::map::lane::LaneDirection> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::lane::LaneDirection const &value, FormatContext &ctx)
  {
