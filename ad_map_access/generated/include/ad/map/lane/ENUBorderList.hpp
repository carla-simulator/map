 ...
 */
template <> struct fmt::formatter<::ad::map::lane::ENUBorderList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::lane::ENUBorderList const &value, FormatContext &ctx)
  {
