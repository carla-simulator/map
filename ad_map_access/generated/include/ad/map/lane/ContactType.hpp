 ...
 */
template <> struct fmt::formatter<::ad::map::lane::ContactType> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::lane::ContactType const &value, FormatContext &ctx)
  {
