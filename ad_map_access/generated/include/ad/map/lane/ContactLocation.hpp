 ...
 */
template <> struct fmt::formatter<::ad::map::lane::ContactLocation> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::lane::ContactLocation const &value, FormatContext &ctx)
  {
