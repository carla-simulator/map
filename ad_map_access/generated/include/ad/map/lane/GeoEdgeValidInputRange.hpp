 ...
 */
inline bool withinValidInputRange(::ad::map::lane::GeoEdge const &input, bool const logErrors = true)
{
  ...
  {
    spdlog::error("withinValidInputRange(::ad::map::lane::GeoEdge)>> {} has invalid member",
