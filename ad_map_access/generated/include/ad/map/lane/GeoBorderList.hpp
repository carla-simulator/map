 ...
 */
template <> struct fmt::formatter<::ad::map::lane::GeoBorderList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::lane::GeoBorderList const &value, FormatContext &ctx)
  {
