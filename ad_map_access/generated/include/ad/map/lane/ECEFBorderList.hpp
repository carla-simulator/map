 ...
 */
template <> struct fmt::formatter<::ad::map::lane::ECEFBorderList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::lane::ECEFBorderList const &value, FormatContext &ctx)
  {
