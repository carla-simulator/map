 ...
 */
template <> struct fmt::formatter<::ad::map::match::MapMatchedPositionType> : formatter<string_view>
{
  template <typename FormatContext>
  auto format(::ad::map::match::MapMatchedPositionType const &value, FormatContext &ctx)
  {
