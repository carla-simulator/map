 ...
 */
template <> struct fmt::formatter<::ad::map::match::MapMatchedPositionConfidenceList> : formatter<string_view>
{
  template <typename FormatContext>
  auto format(::ad::map::match::MapMatchedPositionConfidenceList const &value, FormatContext &ctx)
  {
