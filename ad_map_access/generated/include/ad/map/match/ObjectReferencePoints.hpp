 ...
 */
template <> struct fmt::formatter<::ad::map::match::ObjectReferencePoints> : formatter<string_view>
{
  template <typename FormatContext>
  auto format(::ad::map::match::ObjectReferencePoints const &value, FormatContext &ctx)
  {
