 ...
 */
template <> struct fmt::formatter<::ad::map::match::LaneOccupiedRegionList> : formatter<string_view>
{
  template <typename FormatContext>
  auto format(::ad::map::match::LaneOccupiedRegionList const &value, FormatContext &ctx)
  {
