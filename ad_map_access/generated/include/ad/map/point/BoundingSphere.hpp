 ...
 *
 */
inline std::ostream &operator<<(std::ostream &os, BoundingSphere const &_value)
{
  os << "BoundingSphere(";
  os << "center:";
  os << _value.center;
 ...
 */
template <> struct fmt::formatter<::ad::map::point::BoundingSphere> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::point::BoundingSphere const &value, FormatContext &ctx)
  {
