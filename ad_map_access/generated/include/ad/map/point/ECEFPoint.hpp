 ...
 */
template <> struct fmt::formatter<::ad::map::point::ECEFPoint> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::point::ECEFPoint const &value, FormatContext &ctx)
  {
