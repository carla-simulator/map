 ...
 */
template <> struct fmt::formatter<::ad::map::point::ECEFHeading> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::point::ECEFHeading const &value, FormatContext &ctx)
  {
