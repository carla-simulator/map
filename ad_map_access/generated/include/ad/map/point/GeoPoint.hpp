 ...
 */
template <> struct fmt::formatter<::ad::map::point::GeoPoint> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::point::GeoPoint const &value, FormatContext &ctx)
  {
