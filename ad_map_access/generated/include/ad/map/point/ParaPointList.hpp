 ...
 */
template <> struct fmt::formatter<::ad::map::point::ParaPointList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::point::ParaPointList const &value, FormatContext &ctx)
  {
