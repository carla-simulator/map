 ...
 */
template <> struct fmt::formatter<::ad::map::point::ENUPoint> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::point::ENUPoint const &value, FormatContext &ctx)
  {
