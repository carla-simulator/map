 ...
 */
template <> struct fmt::formatter<::ad::map::landmark::ENULandmarkList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::landmark::ENULandmarkList const &value, FormatContext &ctx)
  {
