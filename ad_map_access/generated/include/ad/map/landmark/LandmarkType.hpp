 ...
 */
template <> struct fmt::formatter<::ad::map::landmark::LandmarkType> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::landmark::LandmarkType const &value, FormatContext &ctx)
  {
