 ...
 */
template <> struct fmt::formatter<::ad::map::landmark::LandmarkIdList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::landmark::LandmarkIdList const &value, FormatContext &ctx)
  {
