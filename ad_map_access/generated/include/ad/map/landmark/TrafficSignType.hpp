 ...
 */
template <> struct fmt::formatter<::ad::map::landmark::TrafficSignType> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::landmark::TrafficSignType const &value, FormatContext &ctx)
  {
