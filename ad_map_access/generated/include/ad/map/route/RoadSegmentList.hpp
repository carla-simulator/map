 ...
 */
template <> struct fmt::formatter<::ad::map::route::RoadSegmentList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::route::RoadSegmentList const &value, FormatContext &ctx)
  {
