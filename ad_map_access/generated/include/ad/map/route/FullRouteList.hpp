 ...
 */
template <> struct fmt::formatter<::ad::map::route::FullRouteList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::route::FullRouteList const &value, FormatContext &ctx)
  {
