 ...
 */
template <> struct fmt::formatter<::ad::map::route::LaneChangeDirection> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::route::LaneChangeDirection const &value, FormatContext &ctx)
  {
