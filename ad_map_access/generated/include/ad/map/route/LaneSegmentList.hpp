 ...
 */
template <> struct fmt::formatter<::ad::map::route::LaneSegmentList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::route::LaneSegmentList const &value, FormatContext &ctx)
  {
