 ...
 */
template <> struct fmt::formatter<::ad::map::route::RouteCreationMode> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::route::RouteCreationMode const &value, FormatContext &ctx)
  {
