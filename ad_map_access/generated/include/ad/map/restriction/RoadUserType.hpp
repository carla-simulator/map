 ...
 */
template <> struct fmt::formatter<::ad::map::restriction::RoadUserType> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::restriction::RoadUserType const &value, FormatContext &ctx)
  {
