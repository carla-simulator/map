 ...
 */
template <> struct fmt::formatter<::ad::map::restriction::SpeedLimitList> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::restriction::SpeedLimitList const &value, FormatContext &ctx)
  {
