...
struct Restrictions
{
  ...
  {
    return (conjunctions == other.conjunctions) && (disjunctions == other.disjunctions);
  }
 ...
 */
inline std::string to_string(::ad::map::restriction::Restrictions const &value)
{
 ...
 */
template <> struct fmt::formatter<::ad::map::restriction::Restrictions> : formatter<string_view>
{
  template <typename FormatContext> auto format(::ad::map::restriction::Restrictions const &value, FormatContext &ctx)
  {
