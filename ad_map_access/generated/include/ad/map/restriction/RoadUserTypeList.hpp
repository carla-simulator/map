 ...
 */
template <> struct fmt::formatter<::ad::map::restriction::RoadUserTypeList> : formatter<string_view>
{
  template <typename FormatContext>
  auto format(::ad::map::restriction::RoadUserTypeList const &value, FormatContext &ctx)
  {
