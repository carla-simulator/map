...
std::string toString(::ad::map::match::ObjectReferencePoints const e)
{
  switch (e)
  {
    case ::ad::map::match::ObjectReferencePoints::FrontLeft:
      return std::string("::ad::map::match::ObjectReferencePoints::FrontLeft"); // LCOV_EXCL_BR_LINE
    case ::ad::map::match::ObjectReferencePoints::FrontRight:
      return std::string("::ad::map::match::ObjectReferencePoints::FrontRight"); // LCOV_EXCL_BR_LINE
    case ::ad::map::match::ObjectReferencePoints::RearLeft:
      return std::string("::ad::map::match::ObjectReferencePoints::RearLeft"); // LCOV_EXCL_BR_LINE
    case ::ad::map::match::ObjectReferencePoints::RearRight:
      return std::string("::ad::map::match::ObjectReferencePoints::RearRight"); // LCOV_EXCL_BR_LINE
    case ::ad::map::match::ObjectReferencePoints::Center:
      return std::string("::ad::map::match::ObjectReferencePoints::Center"); // LCOV_EXCL_BR_LINE
    case ::ad::map::match::ObjectReferencePoints::NumPoints:
      return std::string("::ad::map::match::ObjectReferencePoints::NumPoints"); // LCOV_EXCL_BR_LINE
    default:
...
{
  if (str == std::string("::ad::map::match::ObjectReferencePoints::FrontLeft")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::match::ObjectReferencePoints::FrontRight")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::match::ObjectReferencePoints::RearLeft")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::match::ObjectReferencePoints::RearRight")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::match::ObjectReferencePoints::Center")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::match::ObjectReferencePoints::NumPoints")) // LCOV_EXCL_BR_LINE
  {
