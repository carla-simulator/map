...
std::string toString(::ad::map::lane::LaneDirection const e)
{
  switch (e)
  {
    case ::ad::map::lane::LaneDirection::INVALID:
      return std::string("::ad::map::lane::LaneDirection::INVALID"); // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneDirection::UNKNOWN:
      return std::string("::ad::map::lane::LaneDirection::UNKNOWN"); // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneDirection::POSITIVE:
      return std::string("::ad::map::lane::LaneDirection::POSITIVE"); // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneDirection::NEGATIVE:
      return std::string("::ad::map::lane::LaneDirection::NEGATIVE"); // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneDirection::REVERSABLE:
      return std::string("::ad::map::lane::LaneDirection::REVERSABLE"); // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneDirection::BIDIRECTIONAL:
      return std::string("::ad::map::lane::LaneDirection::BIDIRECTIONAL"); // LCOV_EXCL_BR_LINE
    case ::ad::map::lane::LaneDirection::NONE:
      return std::string("::ad::map::lane::LaneDirection::NONE"); // LCOV_EXCL_BR_LINE
    default:
...
{
  if (str == std::string("::ad::map::lane::LaneDirection::INVALID")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::lane::LaneDirection::UNKNOWN")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::lane::LaneDirection::POSITIVE")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::lane::LaneDirection::NEGATIVE")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::lane::LaneDirection::REVERSABLE")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::lane::LaneDirection::BIDIRECTIONAL")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::lane::LaneDirection::NONE")) // LCOV_EXCL_BR_LINE
  {
