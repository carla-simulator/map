...
std::string toString(::ad::map::intersection::TurnDirection const e)
{
  switch (e)
  {
    case ::ad::map::intersection::TurnDirection::Unknown:
      return std::string("::ad::map::intersection::TurnDirection::Unknown"); // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::TurnDirection::Right:
      return std::string("::ad::map::intersection::TurnDirection::Right"); // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::TurnDirection::Straight:
      return std::string("::ad::map::intersection::TurnDirection::Straight"); // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::TurnDirection::Left:
      return std::string("::ad::map::intersection::TurnDirection::Left"); // LCOV_EXCL_BR_LINE
    case ::ad::map::intersection::TurnDirection::UTurn:
      return std::string("::ad::map::intersection::TurnDirection::UTurn"); // LCOV_EXCL_BR_LINE
    default:
...
{
  if (str == std::string("::ad::map::intersection::TurnDirection::Unknown")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::intersection::TurnDirection::Right")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::intersection::TurnDirection::Straight")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::intersection::TurnDirection::Left")) // LCOV_EXCL_BR_LINE
  {
  ...
  if (str == std::string("::ad::map::intersection::TurnDirection::UTurn")) // LCOV_EXCL_BR_LINE
  {
