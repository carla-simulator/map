 ...
 */
inline GeoPoint createGeoPoint(Longitude const longitude, Latitude const latitude, Altitude const altitude)
{
  GeoPoint result;
 ...
 * @returns Distance between this and other point not taking in account altitude.
 */
 ...
 */
template <> inline GeoPoint vectorExtrapolate(GeoPoint const &a, GeoPoint const &b, double const &scalar)
{
  GeoPoint result;
