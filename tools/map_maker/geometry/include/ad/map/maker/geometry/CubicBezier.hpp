...
/**
 * @brief This struct provides methods to perform a cubic bezier interpolation for a set of (exactly 4)
 *        2D points.
 *
 ...
 *
 *
 *        Usage: 1. CubicBezier bezierCurve;
...
struct CubicBezier
{
   ...
   * @note Exactly 4 control points are required
   */
  ...
  /**
   * @brief Perform an interpolation along the cubic bezier curve
